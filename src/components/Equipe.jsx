...
const Equipe = () => {
    const membros = [
        { id: 1, nome: "Felipe", cargo: "Fotografo", img: "../public/Equipe/Felipe/Felipe-Photo2.jpg" },
        { id: 2, nome: "Tully", cargo: "Fotografa", img: "../public/Equipe/Tully/Tully.jpg" }, // Troquei para uma mulher para variar
