        ...
        <section className="studio-banner" ref={sectionRef}>
            ...
            <div className={`banner-content ${isVisible ? 'visible' : ''}`}>
                ...
                <div className="features-icon-grid">
                    ...
                    <div className="feature-icon-item" title="Janelas amplas com difusores">
                        <div className="icon-wrapper"><IoMdSunny /></div>
                    ...
                    <div className="feature-icon-item" title="Cyclorama profissional">
                        <div className="icon-wrapper"><TbInfinity /></div>
                ...
                <Link to="/informacoes" className="cta-button">
                ...
                <div className={`instagram-wrapper ${isVisible ? 'visible' : ''}`}>
                    ...
                    <blockquote
                        ...
                        style={{
                            ...
                            minWidth: '326px',
                            padding: '0',
                            /* CORREÇÃO AQUI: Apenas uma definição de width */
                            width: 'calc(100% - 2px)'
                        }}
                    >
                        <div style={{ padding: '16px' }}>
                            <a
                                href="https://www.instagram.com/reel/DRPW7GFDhUJ/?utm_source=ig_embed&amp;utm_campaign=loading"
                                style={{ background: '#FFFFFF', lineHeight: '0', padding: '0 0', textAlign: 'center', textDecoration: 'none', width: '100%' }}
                                target="_blank"
                                rel="noreferrer"
                            >
                                {/* Placeholder Visual do Instagram */}
                            ...
                            <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                <a href="https://www.instagram.com/reel/DRPW7GFDhUJ/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noreferrer">
                                    Um post compartilhado por Estúdio Vetra - Brasília (@estudiovetra)
                                </a>
                            </p>
                        </div>
                    </blockquote>
